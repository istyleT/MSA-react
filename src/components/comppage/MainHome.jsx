  ...
  return (
    <section className="d-flex flex-column align-items-center bg-white border border-4 border-end-0 border-start-0 border-danger">
      ...
      >
        ...
        <div
          id="sale-content"
          className="d-flex flex-column justify-content-center align-items-start gap-2 px-5 "
        >
          ...
          <p className="text-wrap">
            ...
            Eligendi, et. Lorem ipsum dolor sit amet, consectetur adipisicing
            elit. Eligendi, et.
          </p>
        </div>
      </div>
      <div
        id="service-box"
        className="d-flex flex-row-reverse justify-content-evenly  align-items-center"
      >
