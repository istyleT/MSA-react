...
import DataReward from "../../data/datapage/datareward";
  ...
  return (
    <Rewardelement reverse={reverse}>
      <div className="col-md-7 d-flex flex-column justify-content-center p-5">
        <h6 className="featurette-heading border-bottom border-danger pb-2">
          {title}
        </h6>
      ...
      <div className="col-md-5 my-1">
        <img
          ...
          alt="reward"
          src={urlimagesreward}
          className="featurette-image img-fluid mx-auto border border-light  rounded-circle px-3"
          width="400"
          height="400"
        />
      </div>
...
const Reward = () => {
  ...
  return (
    <section className="section-reward p-4 bg-white" id="sec-reward">
      <h1 className="d-flex justify-content-center p-4 fw-bold lh-1 font-monospace">
        Reward & Archiement
      </h1>
      {DataRewardList}
    </section>
