...
`;
const FooterLinkPage = styled(Link)`
  color: black;
  font-size: 1.0rem;
  background-color: transparent
  display: flex;
    ...
    <>
      <Footer>
        <img
          ...
          alt="logo"
          className="logo"
          style={{ width: 230 + "px", height: 150 + "px" }}
        />
        <FooterMenu>
        ...
        <FooterMenu>
          ...
          <FooterLink
            target="_blank"
            href="https://page.line.me/465zwbwo?openQrModal=true"
          >
            สาขาศรีนครินทร์
          </FooterLink>
          <FooterLink
          ...
          <FooterLink
            target="_blank"
            href="https://page.line.me/294mktau?openQrModal=true"
          >
            สาขารังสิต คลอง 4
          </FooterLink>
        </FooterMenu>
        <FooterMenu>
          ...
          <FooterLinkPage to="/Contactus">ติดต่อเรา</FooterLinkPage>
          <FooterLinkPage to="/Joinus">ร่วมงานกับเรา</FooterLinkPage>
        </FooterMenu>
      </Footer>
    </>
  );
